...
- 4K 图片批量合成内存假死修复 ✅ `06f1dfa` — 验证: 图片合成并发由固定 6 路改为按最终画布像素与实拍质感动态限制；1920×1080 实拍质感保持 6 路，2560×1920 为 3 路，3840×2160 或 3840×5120 为 1 路，避免多份 float32 大数组同时驻留触发 macOS 交换；批量合成回归与语法检查通过。1344 张真实外置盘批次和冻结 App 由用户验证

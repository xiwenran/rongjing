...
- 页面视频支持不配乐、固定配乐和随机配乐，默认音量 35%；从音频第 1 秒开始使用，短音频循环同一首曲目，并编码为 48 kHz 双声道 AAC
...
- M1–M3 已验证音乐库导入、固定/随机/不配乐、35% 音量、1 秒起点、同曲循环与 48 kHz 双声道 AAC；AAC 尾部可能出现编码器填充，音乐库索引尚未使用持久 sidecar，这两项为非阻断风险。
